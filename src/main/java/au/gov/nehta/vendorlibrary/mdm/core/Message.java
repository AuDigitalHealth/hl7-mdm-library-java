...
import au.gov.nehta.vendorlibrary.mdm.segments.*;
...
public class Message {
    ...
    public static Message parse(String parseValue) {
        ...
        List<String> segments = new ArrayList<>(Arrays.asList(parseValue.split(MDMConstants.SEGMENT_TERMINATOR)));
