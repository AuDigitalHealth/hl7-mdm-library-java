...
public final class PV1 {
    ...
    public String toString() {
        String sb = PV1_SEGMENT_NAME +
                MDMConstants.FIELD_SEPARATOR +
                SET_ID +
                MDMConstants.FIELD_SEPARATOR +
                patientClass +
                MDMConstants.FIELD_SEPARATOR +
                ...
                MDMConstants.FIELD_SEPARATOR +
                consultingDoctor +
                MDMConstants.SEGMENT_TERMINATOR;
        return sb;
    }
    ...
    public static PV1 parse(String parseValue) {
        ...
        List<String> fields = new ArrayList<>(Arrays.asList(parseValue.split("\\" + MDMConstants.FIELD_SEPARATOR)));
