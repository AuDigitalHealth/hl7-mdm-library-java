...
public final class CX {
    ...
    public String toString() {
        String sb = identifier +
                MDMConstants.VALUE_SEPARATOR +
                MDMConstants.VALUE_SEPARATOR +
                MDMConstants.VALUE_SEPARATOR +
                assigningAuthority.toString() +
                MDMConstants.VALUE_SEPARATOR +
                identifierTypeCode;
        return sb.replaceAll(String.format("\\%s*$", MDMConstants.VALUE_SEPARATOR), "");
    }
    ...
    public static CX parse(String parseValue) {
        ...
        List<String> values = new ArrayList<>(Arrays.asList(parseValue.split("\\" + MDMConstants.VALUE_SEPARATOR)));
    ...
    public static final class Builder {
        ...
        public CX build() throws MDMValidationException {
            Map<String, List<String>> failedVariables = new HashMap<>();
